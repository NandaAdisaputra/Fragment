...
class MovieAdapter(val movies : ArrayList<ResultsItem>) :
    ...
    class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(p0: View?) {
            Toast.makeText(view.context, "Item Telah di Klik",
        ...
        fun bind(movie: ResultsItem) {
            ...
            imageUrl.append(view.context.getString(R.string.BASE_URL_IMAGE))
